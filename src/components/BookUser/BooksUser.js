    ...
    return (
        <div>
            <div className="category-buttons">
                ...
                <button onClick={() => changeCategory(1)}>AC</button>
                <button onClick={() => changeCategory(2)}>Washing Machine</button>
                <button onClick={() => changeCategory(3)}>TV</button>
                <button onClick={() => changeCategory(4)}>Refrigerator</button>
            </div>
            <ul>
