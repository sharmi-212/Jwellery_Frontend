...
const BackgroundContainer = styled('div')({
  ...
  minHeight: '100vh',
  margin: 0,
  backgroundImage: `url("https://blog.gowarranty.in/wp-content/uploads/2020/04/HomeAppliancesWecantlivewithout-800x445.jpeg")`,
...
function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post('https://https://home-appliances-be.onrender.com/users/login', { email, password, isAdmin });
